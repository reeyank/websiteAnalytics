  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-[var(--foreground)] mb-2">Sessions</h1>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 rounded-xl bg-[var(--card)] border border-[var(--border)] text-[var(--foreground)] placeholder-gray-500 focus:outline-none focus:border-[var(--accent)] transition-colors"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-xl bg-green-500/10 border border-green-500/20">
          ...
          <p className="text-2xl font-bold text-green-700 dark:text-green-400">{activeSessions}</p>
        </div>
        <div className="p-4 rounded-xl bg-gray-500/10 border border-gray-500/20">
          <p className="text-sm text-[var(--muted-foreground)]">Ended</p>
          <p className="text-2xl font-bold text-gray-700 dark:text-gray-300">{endedSessions}</p>
        </div>
        <div className="p-4 rounded-xl bg-[var(--card)] border border-[var(--border)]">
          <p className="text-sm text-[var(--muted-foreground)]">Showing</p>
          <p className="text-2xl font-bold text-[var(--foreground)]">{filteredSessions.length}</p>
        </div>
      </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right hidden md:block">
                    <p className="text-xs text-[var(--muted-foreground)]">First seen</p>
                  ...
                  <ChevronRight className="w-5 h-5 text-[var(--muted-foreground)] group-hover:text-[var(--accent)] group-hover:translate-x-1 transition-all" />
                </div>
              </div>
            </Link>
          ))
